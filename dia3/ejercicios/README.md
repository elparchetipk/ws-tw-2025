...
var userMessage = 'Hola, ' + userName + '! Tienes ' + userAge + ' años y tu email es ' + userEmail;
...
var productInfo = 'Producto: ' + product.name + '\n' +
                  'Precio: $' + product.price + '\n' +
                  'Descuento: ' + (product.discount * 100) + '%\n' +
                  'Precio final: $' + (product.price * (1 - product.discount));
...
const sampleProducts = [
    ...
    { id: 2, name: 'Mouse', price: 25, category: 'electronics', image: 'mouse.jpg' },
    { id: 3, name: 'Desk', price: 150, category: 'furniture', image: 'desk.jpg' },
    { id: 4, name: 'Chair', price: 200, category: 'furniture', image: 'chair.jpg' }
];
